...
// to gzip it.
func GenerateLayer(path string, deltas []mtree.InodeDelta, opt *PackOptions) (io.ReadCloser, error) {
...
func GenerateInsertLayer(root string, target string, opaque bool, opt *PackOptions) io.ReadCloser {
	root = CleanPath(root)
